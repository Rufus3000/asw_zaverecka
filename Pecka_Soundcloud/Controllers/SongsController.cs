...
namespace Pecka_Soundcloud.Controllers
{
    public class SongsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Songs.Include(s => s.Album).Include(s => s.Interpret);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ReleaseDate,Type,AlbumId,InterpretId")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ReleaseDate,Type,AlbumId,InterpretId")] Song song)
        {
            if (id != song.Id)
            {
                return NotFound();
